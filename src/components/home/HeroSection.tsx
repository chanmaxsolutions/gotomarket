            ...
            <div className="container">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    >
                        <Link
                            href="/contact"
                            className="px-8 py-4 bg-primary text-white rounded-full text-lg hover:bg-primary/90 transition-colors duration-200 flex items-center gap-2 group"
                        >
                            {t('hero.cta.primary')}
                        ...
                        <Link
                            href="/services"
                            className="px-8 py-4 border border-gray-200 text-neutral-dark rounded-full text-lg hover:bg-neutral-light/50 transition-colors duration-200 flex items-center gap-2 group"
                        >
